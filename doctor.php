...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="doctor.php"><i class="fa fa-female"></i> Patient</a></li>
                  <li><a href="doctor-appoinment.php"><i class="fa fa-calendar"></i> Appoinment</a></li>
                  <li><a onclick="logout('index.php#doctor')"><i class="fa fa-sign-out"></i> Logout</a></li>
                </ul>
              </div>
                    ...
                    <div class="x_content">
                      <div class="form-group">
                        ...
                        <div class="col-md-6">
                          ...
                          <button class="btn btn-success col-md-1" onclick="searchPatient()">Search</button>
    ...
    <script src="js/function/doctor.js"></script>
